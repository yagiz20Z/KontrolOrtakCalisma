...
#ifndef INC_TANIMLAMA_H_
#define INC_TANIMLAMA_H_
...
// buranın altındakiler queue ile diğer task'e aktarılacaktır ve karışıklık olmaması için  ayrılmıştır
